...
export default function CVPage() {
    return (
        <main className="flex flex-col items-start justify-left mx-10 p-5 md:px-24 sxl:px-32">
            ...
            <PresentationTable 
                columns={["Period", "Education", "Institution"]}
                data={[
                    { period: "Aug 2014 – Jun 2020", education: "PhD in Economics, Center of Applied Macro and Commodity Prices (CAMP)", institution: "BI Norwegian Business School" },
                    { period: "Aug 2012 – Jun 2014", education: "MSc Economics and Business Administration", institution: "NHH Norwegian School of Economics" },
                    { period: "Aug 2009 – Jun 2012", education: "BSc in Business and IT", institution: "University of Nordland" },
                    { period: "Aug 2010 – Jun 2011", education: "Interior Designer", institution: "Interior School" },
                ]}
            />
